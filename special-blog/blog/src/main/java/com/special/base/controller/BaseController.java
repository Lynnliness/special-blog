...
public class BaseController {
	...
	public JsonResult ExceptionHandler(HttpServletRequest request, Exception exception) {
		...
		return new JsonResult(false, message, exception.getMessage());
	}
	 ...
	 *            提示成功信息
	 * @return 包含成功提示的JsonResult
	 */
	protected JsonResult successResult(String successMessage) {
		return successResult(successMessage, null);
	}
	 ...
	 * @param data
	 *            返回数据
	 * @return 包含成功提示和数据的JsonResult
	 */
	protected JsonResult successResult(String successMessage, Object data) {
		JsonResult jsonResult = new JsonResult();
		jsonResult.setMessage(successMessage);
		jsonResult.setSuccess(true);
		jsonResult.setModel(data);
		return jsonResult;
	}
	...
	protected JsonResult errorResult(String errorMessage) {
		return errorResult(errorMessage, null);
	}
	 ...
	 * @param data
	 *            返回数据
	 * @return 包含错误提示和数据的JsonResult
	 */
	protected JsonResult errorResult(String errorMessage, Object data) {
		JsonResult jsonResult = new JsonResult();
