	...
	<div class="banner"
		...
		<div class="container banner-drop">
			<div class="header">
				...
				<div class="header-right">
					...
					<div id="home_menu_layer" class="menu-icon animated wow zoomIn"
		...
		<div class="banner-btm-grid-w3ls">
			...
			<div class="banner-right-w3-agileits">
				<div class="container">
					<div id="player1" class="aplayer" style="width: 27%"></div>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
...
<div class="about" id="about">
	<div class="container">
		...
		<p class="para-w3-agile">
			2012年6月，参加校外培训机构，2013年5月毕业，属于保留专科学籍，校外培训，工作经验3-4年。</br>希望可以找到一个团队氛围好，工作环境安静，都不错的的工作，期望月薪15-16K，职业规划为架构师，待人真诚，乐于助人，有耐心，热爱学习新技术
		</p>
				...
				<section class='wrap'>
					<div class='wrap_right'>
						<div class='bar_group'>
							...
							<div class='bar_group__bar thin' label='EXTJS' show_values='true'
								tooltip='true' value='200'></div>
							<div class='bar_group__bar thin' label='HTML' show_values='true'
							...
							<div class='bar_group__bar thin' label='MAVEN' show_values='true'
								tooltip='true' value='670'></div>
							<div class='bar_group__bar thin' label='MYBATIS'
								show_values='true' tooltip='true' value='650'></div>
							<div class='bar_group__bar thin' label='MYSQL' show_values='true'
								tooltip='true' value='650'></div>
						</div>
	...
	<div class="container">
		...
		<div class="work-info">
			...
			<div class="col-md-6 work-left work-left2">
				<h5>
					<li>杭州润通科技有限公司</li>
					<a href="www.56123.com" target="_blank">浙江嵊州茂乾物流网点管理系统</a><span class="glyphicon glyphicon-briefcase"></span>
				</h5>
				<p>
				对运单进行开单保存，修改运单，未确认交易订单取消，确认交易，安排提货，确认到站，关闭运单，确认签收等操作.
		...
		<div class="work-info">
			...
			<div class="col-md-6 work-right">
				<h5>
					...
					<a href="www.butchart.com" target="_blank">布查德花店</a>
				</h5>
		...
		<div class="work-info">
			...
			<div class="col-md-6 work-left work-left2">
				<h5>
					<a href="http://www.zyzhoto.com/shop/" target="_blank">九牛手机零售网</a>
					<span class="glyphicon glyphicon-briefcase"></span>
				</h5>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		layer.tips("点击快速导航", '#home_menu_layer');
